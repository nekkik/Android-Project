...
//        avatartv = view.findViewById(R.id.avatarid);
        nametv = view.findViewById(R.id.createProName);
        emailtv = view.findViewById(R.id.createProMajor);
        phonetv = view.findViewById(R.id.createProDOB);
        skillstv = view.findViewById(R.id.createProPhoneno);
